...
class ServiceClientType(object):
    ...
    def __init__(self):  # noqa: E501
        """ServiceClientType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceClientType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceClientType):
            return False
