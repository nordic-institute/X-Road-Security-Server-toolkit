...
class DistinguishedName(object):
    ...
    @property
    def name(self):
        """Gets the name of this DistinguishedName.  # noqa: E501

        distinguished name  # noqa: E501

        :return: The name of this DistinguishedName.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DistinguishedName.

        distinguished name  # noqa: E501

        :param name: The name of this DistinguishedName.  # noqa: E501
        :type: str
        """
